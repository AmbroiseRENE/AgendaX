...
public class AbstractConstants {
	...
	public static class User {
		public static final String BASE_PATH = GLOBAL_PATH + "user/";
	...
	public static class Chief {
		public static final String BASE_PATH = GLOBAL_PATH + "chief/";
		public static final String CREATE = BASE_PATH + CREATE_PATH;
		public static final String UPDATE = BASE_PATH + UPDATE_PATH;
		public static final String READ_ID = BASE_PATH + READ_ID_PATH;
		public static final String READ_ALL = BASE_PATH + READ_ALL_PATH;
	...
	public static class Experiement {
		public static final String BASE_PATH = GLOBAL_PATH + "experiment/";
		public static final String CREATE = BASE_PATH + CREATE_PATH;
		public static final String UPDATE = BASE_PATH + UPDATE_PATH;
		public static final String READ_ID = BASE_PATH + READ_ID_PATH;
		public static final String READ_ALL = BASE_PATH + READ_ALL_PATH;
	...
	public static class Laboratory {
		public static final String BASE_PATH = GLOBAL_PATH + "laboratory/";
		public static final String CREATE = BASE_PATH + CREATE_PATH;
		public static final String UPDATE = BASE_PATH + UPDATE_PATH;
		public static final String READ_ID = BASE_PATH + READ_ID_PATH;
		public static final String READ_ALL = BASE_PATH + READ_ALL_PATH;
	...
	public static class Manipulation {
		public static final String BASE_PATH = GLOBAL_PATH + "manipulation/";
		public static final String CREATE = BASE_PATH + CREATE_PATH;
		public static final String UPDATE = BASE_PATH + UPDATE_PATH;
		public static final String READ_ID = BASE_PATH + READ_ID_PATH;
		public static final String READ_ALL = BASE_PATH + READ_ALL_PATH;
	...
	public static class Plan {
		public static final String BASE_PATH = GLOBAL_PATH + "plan/";
		public static final String CREATE = BASE_PATH + CREATE_PATH;
		public static final String UPDATE = BASE_PATH + UPDATE_PATH;
		public static final String READ_ID = BASE_PATH + READ_ID_PATH;
		public static final String READ_ALL = BASE_PATH + READ_ALL_PATH;
	...
	public static class Project {
		public static final String BASE_PATH = GLOBAL_PATH + "project/";
		public static final String CREATE = BASE_PATH + CREATE_PATH;
		public static final String UPDATE = BASE_PATH + UPDATE_PATH;
		public static final String READ_ID = BASE_PATH + READ_ID_PATH;
		public static final String READ_ALL = BASE_PATH + READ_ALL_PATH;
	...
	public static class Result {
		public static final String BASE_PATH = GLOBAL_PATH + "result/";
		public static final String CREATE = BASE_PATH + CREATE_PATH;
		public static final String UPDATE = BASE_PATH + UPDATE_PATH;
		public static final String READ_ID = BASE_PATH + READ_ID_PATH;
		public static final String READ_ALL = BASE_PATH + READ_ALL_PATH;
	...
	public static class Team {
		public static final String BASE_PATH = GLOBAL_PATH + "team/";
		public static final String CREATE = BASE_PATH + CREATE_PATH;
		public static final String UPDATE = BASE_PATH + UPDATE_PATH;
		public static final String READ_ID = BASE_PATH + READ_ID_PATH;
		public static final String READ_ALL = BASE_PATH + READ_ALL_PATH;
